            ...
            <div className="content-area">
                <div style={{ display: 'flex', alignItems: 'center', gap: '24px', marginBottom: '32px' }}>
                    ...
                    <div>
                        ...
                        <button className="btn primary-btn" onClick={handlePlayAll} style={{ width: 'auto', marginTop: '16px', display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 32px', borderRadius: '30px' }}>
                ...
                <div className="results-grid" style={{ gridTemplateColumns: '1fr' }}>
                    {playlist.tracks && playlist.tracks.map((track, index) => {
                        ...
                        return (
                            <div className="track-card" key={`${track.videoId}-${index}`} onClick={() => playQueue(playlist.tracks, index)} style={{ flexDirection: 'row', alignItems: 'center', gap: '16px', padding: '12px' }}>
